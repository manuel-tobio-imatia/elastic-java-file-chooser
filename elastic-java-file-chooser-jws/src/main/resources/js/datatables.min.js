 ...
 *   https://datatables.net/download/#dt/jq-2.2.0,dt-1.10.11,cr-1.3.1,fh-3.1.1,r-2.0.2,sc-1.4.1
 *
 * Included libraries:
 *   jQuery 2.2.0, DataTables 1.10.11, ColReorder 1.3.1, FixedHeader 3.1.1, Responsive 2.0.2, Scroller 1.4.1
 */
...
(function(h) {
  ...
  m.defaults = {
    ...
    oLanguage: {
      ...
      sSearchPlaceholder: "",
      sUrl: "",
      sZeroRecords: "No se han encontrado registros que coincidan con los criterios de búsqueda"
    },
  ...
  m.ext = v = {
    buttons: {},
    classes: {},
    build: "dt/jq-2.2.0,dt-1.10.11,cr-1.3.1,fh-3.1.1,r-2.0.2,sc-1.4.1",
    errMode: "alert",
    feature: [],
    search: [],
    selector: {
...
(function(f) {
  ...
  function q(a, c, d) {
    for (var e = [], b = 0, f = a.childNodes.length; b <
      f; b++) 1 == a.childNodes[b].nodeType && e.push(a.childNodes[b]);
    c = e[c];
  ...
  f.fn.dataTableExt.oApi.fnColReorder = function(a, c, d, e) {
    ...
    if (c != d)
      if (0 > c || c >= k) this.oApi._fnLog(a, 1, "ColReorder 'from' index is out of bounds: " + c);
      else if (0 > d || d >= k) this.oApi._fnLog(a, 1, "ColReorder 'to' index is out of bounds: " +
      d);
    else {
      i = [];
      b = 0;
      ...
      b = 0;
      for (g = k; b < g; b++) j = a.aoColumns[b], "number" == typeof j.mData ?
        j.mData = m[j.mData] : f.isPlainObject(j.mData) && (h(j.mData, "_", m), h(j.mData, "filter", m), h(j.mData, "sort", m), h(j.mData, "type", m));
      if (a.aoColumns[c].bVisible) {
        ...
        b = 0;
        for (g = a.aoData.length; b < g; b++) null !== a.aoData[b].nTr &&
  ...
  f.extend(h.prototype, {
    ...
    _fnConstruct: function() {
      ...
      if (b)
        if (a.s.dt._bInitComplete) c = p(b), a._fnOrderColumns.call(a, c);
        else {
          var g = !1;
    ...
    _fnMouseMove: function(a) {
      ...
      for (var c = !1, d = this.s.mouse.toIndex, e = 1, b = this.s.aoTargets.length; e < b; e++)
  ...
  f.fn.DataTable.ColReorder = h;
  "function" == typeof f.fn.dataTable && "function" == typeof f.fn.dataTableExt.fnVersionCheck && f.fn.dataTableExt.fnVersionCheck("1.10.8") ?
...
(function(e) {
  ...
  e.extend(h.prototype, {
    ...
    _fnCalcRowHeight: function() {
      ...
      for (e("tbody tr:lt(4)", b).clone().appendTo(d); 3 >
        e("tr", d).length;) d.append("<tr><td>&nbsp;</td></tr>");
